...
const styles = StyleSheet.create({
  ...
  headerLabel: {
    ...
    letterSpacing: 2.5, marginBottom: Space.xs, textTransform: 'uppercase' as const,
  },
  ...
  // Trust score card — dramatic depth
  scoreCard: {
  ...
  scoreTop: { flexDirection: 'row', alignItems: 'center', gap: Space.xl },
  scoreCircle: {
  ...
  scoreValue: { fontSize: 34, fontWeight: '800' as const, letterSpacing: -1 },
  scoreUnit: { fontSize: 14, fontWeight: '500' as const, color: Colors.textMuted, marginTop: 8 },
  scoreInfo: { flex: 1, gap: Space.sm },
  trustBadge: {
  ...
  trustBadgeText: { fontSize: 12, fontWeight: '700' as const },
  ...
  itemTitle: { fontSize: 15, fontWeight: '700' as const, color: Colors.textPrimary },
  trustPointBadge: {
    backgroundColor: Colors.bgDeep,
  ...
  trustPointText: { fontSize: 10, fontWeight: '700' as const, color: Colors.textMuted },
  ...
  doneText: { fontSize: 13, fontWeight: '600' as const, color: Colors.olive },
  ...
  pendingText: { fontSize: 13, fontWeight: '600' as const, color: Colors.accent },
  ...
  verifyBtnText: { fontSize: 13, fontWeight: '700' as const, color: Colors.white },
  ...
  noticeTitle: { fontSize: 13, fontWeight: '700' as const, color: Colors.textPrimary },
